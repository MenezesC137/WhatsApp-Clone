...
export class Message extends Model {
    ...
    getViewElement(me = true) {
            ...
            case 'image':
                ...
                div.innerHTML = `
                    <div class="_3_7SH _3qMSo">
                        <div class="KYpDv">
                            <div>
                                <div class="_3v3PK" style="width: 330px; height: 320px;">
                                    <div class="_34Olu">
                                        <div class="_2BzIU">
                                            <div class="_2X3l6">
                                    ...
                                    <img src="${this.content}" class="_1JVSX message-photo" style="width: 330px; height: 320px; display:none">
        ...
        if(me) {
            ...
            div.querySelector('.message-time')
