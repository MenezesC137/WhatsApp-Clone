        ...
        switch (this.type) {
                            ...
                            <div class="_3DZ69" role="button">
                                ...
                                <div class="_3a5-b">
                                    <div class="_1DZAH" role="button">
                                        <span class="message-time">${Format.timeStampToTime(this.timeStamps)}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="_6qEXM">
                        ...
                        <div class="_1fnMt _2CORf">
                            <a class="_1vKRe" href="#">
                                ...
                                <div class="_12xX7">
                                    ...
                                    <div class="nxILt">
                                        <span dir="auto" class="message-filename">${this.file.name}</span>
                                    </div>
                                    <div class="_17viz">
            ...
            case 'audio':
                ...
                audioEl.onpause= e=>{
                    ...
                    audioDuration = Format.toTime(this.duration * 1000)
                    btnPlay.show();
                    btnPause.hide();
